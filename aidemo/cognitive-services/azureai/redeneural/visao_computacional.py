...
NOME_VARIAVEL_CHAVE = "CHAVE_DA_SUBSCRICAO" #isso é uma variável de ambiente
LOCAL_VISION = os.environ.get(
    "LOCAL_DA_SUBSCRICAO", "eastus") #isso também é uma variável de ambiente
...
if __name__ == "__main__":
    ...
    from azureai.launcher import executar_launcher
    executar_launcher(globals(), NOME_VARIAVEL_CHAVE)
